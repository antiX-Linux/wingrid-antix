...
# Note this value is overridden because the window is maximized vertically when put in the grid pattern
OFFSETTOP=$GAPTOP
...
# Note maximizing vertically enables the window to scroll to the end of long files
